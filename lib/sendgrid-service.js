...
export async function sendAdminNotification(consultationData) {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p style="font-size: 12px; color: #94a3b8;">This email was sent from the AtarWeb consultation system.</p>
    </div>
  `
...
export async function sendClientConfirmation(consultationData) {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>If you have any questions, please don't hesitate to contact us at <a href="mailto:admin@atarweb.com" style="color: #2563eb;">admin@atarweb.com</a></p>
      <hr style="margin: 20px 0; border: none; border-top: 1px solid #e2e8f0;">
      <p style="font-size: 12px; color: #94a3b8;">Best regards,<br>The AtarWeb Team</p>
    </div>
  `
