...
export const emailTemplates = {
  consultationRequest: {
    ...
    client: (data) => ({
      subject: 'Consultation Request Received - AtarWeb',
      html: `
        ...
        <p>If you have any questions, please don't hesitate to contact us at admin@atarweb.com</p>
  ...
  depositPayment: {
    client: (data) => ({
      subject: 'Deposit Payment Confirmation - AtarWeb',
      html: `
    ...
    admin: (data) => ({
      subject: 'Deposit Payment Received - AtarWeb',
      html: `
        <h2>Deposit Payment Received</h2>
  ...
  finalInvoice: {
    client: (data) => ({
      subject: 'Final Invoice - Project Complete - AtarWeb',
      html: `
        ...
        <p>Thank you for choosing AtarWeb for your project needs!</p>
        <p>Best regards,<br>The AtarWeb Team</p>
      `
    }),
    admin: (data) => ({
      subject: 'Final Payment Received - Project Complete - AtarWeb',
      html: `
