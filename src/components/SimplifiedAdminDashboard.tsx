          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-between p-6 border-b border-purple-700">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xl font-bold text-white">AtarWeb</span>
              </div>
              <button 
            ...
            <div className="p-4">
              <div className="flex items-center space-x-3 p-3 bg-purple-800 rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-300">admin@atarweb.com</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 lg:ml-0">
          ...
          <div className="lg:hidden bg-white/80 backdrop-blur-sm shadow-sm border-b border-white/20 p-4">
            <div className="flex items-center justify-between">
              ...
              <h1 className="text-xl font-bold text-gray-900">AtarWeb Admin</h1>
              <button 
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        type="email"
                        defaultValue="admin@atarweb.com"
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                      />
                    </div>
                    <div>
