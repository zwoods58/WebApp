...
`;
    ...
    const onPointerMove = (e: PointerEvent) => {
      ...
      console.log('Mouse moved (container):', { x, y, clientX: e.clientX, clientY: e.clientY, rect });
      if (mouseDampening <= 0) {
    ...
    const onMouseMove = (e: MouseEvent) => {
      ...
      const y = (rect.height - (e.clientY - rect.top)) * scale;
      mouseTargetRef.current = [x, y];
      console.log('Mouse moved (container mousemove):', { x, y, clientX: e.clientX, clientY: e.clientY, rect });
      if (mouseDampening <= 0) {
        uniforms.iMouse.value = [x, y];
      }
    };
