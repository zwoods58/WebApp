...
import { CreditCard, Loader2, CheckCircle, XCircle, ArrowLeft, ExternalLink } from 'lucide-react'
...
export default function SimplePaymentPage() {
  ...
  const createCheckoutSession = async () => {
    ...
    try {
      const response = await fetch('/api/payments/create-checkout', {
        ...
        body: JSON.stringify({ consultationId, paymentType }),
      })
  ...
  const amount = paymentType === 'final' ? (consultation.remainingAmount || 500) : (consultation.depositAmount || 500)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              {creatingCheckout ? (
              ...
              <span>
                {creatingCheckout ? 'Creating Checkout...' : `Pay $${amount.toLocaleString()} with Stripe`}
              </span>
            </button>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-xl">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• Powered by Stripe - Industry standard security</li>
