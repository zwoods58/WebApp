...
export const metadata: Metadata = {
  title: 'Terms of Service - AtarWeb',
  description: 'Terms of Service for AtarWeb professional web development services.',
}
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                By accessing and using AtarWeb's services, you accept and agree to be bound by the terms and provision of this agreement. These Terms of Service govern your use of our web development services, website, and any related services provided by AtarWeb.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                AtarWeb provides professional web development services including but not limited to:
              </p>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Payment terms will be specified in your project agreement. Generally, we require a deposit before work begins, with the remaining balance due upon project completion. All prices are in USD unless otherwise specified.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-medium text-gray-900 mb-2">3.3 Timeline</h3>
                  <p className="text-gray-700">
                    Project timelines are estimates based on the scope of work and client responsiveness. Delays in client feedback or content provision may extend project timelines accordingly.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                AtarWeb's liability for any damages arising from our services shall not exceed the total amount paid by you for the specific project in question. We are not liable for any indirect, incidental, or consequential damages.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700"><strong>Email:</strong> admin@atarweb.com</p>
                <p className="text-gray-700"><strong>Company:</strong> AtarWeb</p>
              </div>
            </section>
