...
export const metadata: Metadata = {
  title: 'Privacy Policy - AtarWeb',
  description: 'Privacy Policy for AtarWeb professional web development services.',
}
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                AtarWeb ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services. Please read this privacy policy carefully.
              </p>
            </section>
