...
import industryTranslations from '../../../translations/industry-translations';
import essentialTranslations from '../../../translations/essential-translations';

// Cache-busting timestamp to force refresh translations
const TRANSLATION_CACHE_BUSTER = '2025-03-20-14-49-34';
