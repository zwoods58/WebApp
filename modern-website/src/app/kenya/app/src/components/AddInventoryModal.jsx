        ...
        >
          ...
          >
            <div className="p-6 pt-4" style={{ paddingBottom: '120px' }}>
              ...
              {/* Voice Input Trigger */}
              {!initialData && (
                <div className="bg-primary-50 rounded-2xl p-4 flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-primary-100 rounded-full flex items-center justify-center text-primary-600">
                      <Mic size={20} />
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-primary-900">{t('common.voiceEntry', 'Voice Entry')}</p>
                      <p className="text-xs text-primary-700">{t('inventory.voiceHelp', 'Try: "Add 10 cans of Coke costing 10 rand selling for 15"')}</p>
                    </div>
                  </div>
                  <button
                    type="button"
                    ...
                    className="bg-primary-600 text-white px-4 py-2 rounded-xl text-sm font-bold shadow-md active:scale-95 transition-all"
                  >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all appearance-none"
                  >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all font-bold text-primary-600"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows="2"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-primary-600 text-white py-4 rounded-2xl font-bold text-lg shadow-lg shadow-primary-200 hover:bg-primary-700 active:scale-[0.98] transition-all disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed mt-4 mb-4 flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
