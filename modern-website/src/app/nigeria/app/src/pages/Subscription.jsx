      ...
      <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold text-gray-900">
                    {t('subscription.full', 'Full Access (AI)')}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">{t('subscription.price', 'Price')}</p>
                  <p className="font-semibold text-gray-900">
                    {`${getPricing('ai')?.displayPrice || 'AI Plan'}/${activeCountry?.pricing?.billingCycle || 'weekly'}`}
                  </p>
                </div>
              </div>
            </div>
        ...
        {!isActive && (
          <div className="space-y-4 max-w-lg mx-auto">
            <h2 className="text-xl font-semibold text-gray-900 text-center px-1">{t('subscription.choosePlan', 'Choose your plan')}</h2>

            <div className="flex justify-center">
              {/* AI Plan */}
              <div className="card border-2 border-primary relative w-full">
                <div className="absolute -top-3 right-4 bg-primary text-white text-xs font-bold px-2 py-1 rounded-full">
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-primary-dark font-bold text-2xl mt-1">
                      {getPricing('ai')?.weeklyDisplay || getPricing('ai')?.displayPrice || 'AI Plan'}
                    </p>
