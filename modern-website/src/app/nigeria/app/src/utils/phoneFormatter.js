 ...
 * Supports country detection for Nigeria, Kenya, and South Africa
 */

import { getCountryByDialCode } from '../config/countries.js';
...
export function formatPhoneNumber(phone) {
  ...
  if (cleaned.startsWith('+')) {
    ...
    // Nigeria (+234): Format as +234 XXX XXX XXXX
    ...
    // Kenya (+254): Format as +254 XXX XXX XXX
 ...
 * Returns country configuration or null if not supported
 */
export function detectCountryFromPhone(phone) {
  ...
  // Check for supported country codes
  if (digits.startsWith('234')) {
    return getCountryByDialCode('+234'); // Nigeria
  } else if (digits.startsWith('254')) {
    return getCountryByDialCode('+254'); // Kenya  
  } else if (digits.startsWith('27')) {
    return getCountryByDialCode('+27'); // South Africa
  }
