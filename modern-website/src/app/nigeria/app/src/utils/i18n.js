...
export function formatNumber(number, options = {}) {
  ...
  return new Intl.NumberFormat('en-NG', defaultOptions).format(number);
}
...
export function formatPercentage(value, options = {}) {
  ...
  return new Intl.NumberFormat('en-NG', defaultOptions).format(value / 100);
}
...
export const translations = {
  ...
  [Languages.HA]: {
    ...
    dashboard: {
      greeting: 'Ina kwana / Barka',
      balance: 'Kudin Kasuwancin Ku',
      moneyIn: 'Kudin Shiga',
      moneyOut: 'Kudin Fita',
    },
  },
  [Languages.YO]: {
    common: {
      ...
      loading: 'Ó ń gbé jáde...',
      error: 'Àṣìṣe',
      success: 'Àṣeyọrí',
    },
    dashboard: {
      greeting: 'Ẹ kú àárọ̀',
      balance: 'Iwontunwonsi Iṣowo rẹ',
      moneyIn: 'Owó Wọlé',
      moneyOut: 'Owó Jáde',
    },
  },
  [Languages.IG]: {
    ...
    dashboard: {
      greeting: 'Ịbọla chi / Ndewo',
      balance: 'Ego Azụmahịa Gị',
      moneyIn: 'Ego na-abata',
      moneyOut: 'Ego na-apụta',
    },
  },
};
