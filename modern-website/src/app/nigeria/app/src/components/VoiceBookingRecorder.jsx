      ...
      <div className="voice-recorder-container">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 p-5 rounded-[24px]">
                  ...
                  <p className="text-lg font-black text-primary-dark">R{extractedData.cost_price || '0'}</p>
                </div>
              </div>
        ...
        <div className="mt-8 grid grid-cols-2 gap-4 pb-10">
          ...
          <button
            ...
            className="bg-primary text-white py-4 rounded-2xl font-black text-base shadow-lg shadow-primary/20 active:scale-95 transition-all flex items-center justify-center gap-2"
          >
        ...
        {isProcessing ? (
          ...
          <div className="flex flex-col items-center gap-6 w-full">
            <div className="relative">
              ...
              <div className="relative w-32 h-32 bg-primary-dark rounded-full flex items-center justify-center text-white shadow-xl shadow-primary/20">
            ...
            <div className="text-center">
              ...
              <p className="text-primary font-bold uppercase tracking-widest text-[10px]">Time Left</p>
            </div>

            <div className="bg-primary/10 p-6 rounded-[32px] w-full max-w-xs border border-primary/20">
              <p className="text-gray-900 text-center font-bold text-sm leading-relaxed italic">
                {type === 'booking'
          ...
          <div className="flex flex-col items-center gap-6 w-full">
            ...
            <button
              ...
              className="w-full max-w-xs bg-primary text-white py-5 rounded-[24px] font-black text-lg shadow-xl shadow-primary/20 active:scale-95 transition-all flex items-center justify-center gap-3"
            >
