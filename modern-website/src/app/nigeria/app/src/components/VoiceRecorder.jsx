      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-6">
          ...
          <div className="text-center">
            <div className={`inline-flex items-center gap-2 px-6 py-3 rounded-full text-xl font-bold ${isIncome ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
              }`}>
          ...
          <div className="text-center">
            ...
            <p className={`text-5xl font-bold ${isIncome ? 'text-green-600' : 'text-red-600'
              }`}>
      ...
      <div className="bg-white rounded-2xl max-w-md w-full p-8 space-y-8">
        ...
        <div className="flex justify-center">
          <button
            ...
            disabled={isProcessing}
            className={`relative w-40 h-40 rounded-full flex items-center justify-center transition-all ${isRecording
        ...
        <div className="bg-primary/10 rounded-lg p-4 text-center space-y-2">
          <p className="text-gray-900 font-semibold">💡 Examples:</p>
