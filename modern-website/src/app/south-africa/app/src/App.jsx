...
function App() {
  ...
  // Step 6: Additional PWA Formatting Fixes for Mobile
  useEffect(() => {
    ...
    // Set viewport height variable for better mobile support
    const setVH = () => {
  ...
  return (
    <PlatformRedirect>
      <BrowserRouter basename="/south-africa/app">
        <Routes>
          {/* Auth Routes */}
          ...
          >
            ...
            <Route path="settings/security" element={<ActiveSessions />} />
