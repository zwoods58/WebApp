...
export default function OnboardingFlow() {
  ...
  const handlePhoneSubmit = async () => {
    ...
    if (!countryDetected) {
      toast.error('Unsupported country. BeeZee is currently in ZA, KE, NG.');
      return;
    }
    ...
    try {
      ...
      const res = await AuthService.requestVerification(localPhone, activeCountry?.code || 'ZA', 'signup');
  ...
  const handleSignupSubmit = async () => {
    ...
    try {
      ...
      if (res.success) {
        toast.success('Welcome to BeeZee ZA! 🎉');
      ...
      <div className="auth-card">
        ...
        {step === STEPS.PHONE && (
          <div className="auth-form">
            <div className="auth-card-header">
              ...
              <h2 className="auth-card-title">Welcome to BeeZee South Africa</h2>
        ...
        {step === STEPS.PROFILE && (
          <div className="auth-form">
            <div className="auth-card-header">
              ...
              <h2 className="auth-card-title">Profile Setup</h2>
            ...
            <div className="auth-form-field">
              ...
              <p className="text-xs text-gray-500 mt-1">Needed if you forget your PIN or lose access</p>
            </div>

            <button onClick={handleProfileSubmit} className="auth-cta-button">
              Next: Security <ArrowRight size={20} />
            </button>
          </div>
        )}
        ...
        {step === STEPS.SUCCESS && (
          <div className="auth-form text-center p-6">
            ...
            <p className="text-gray-600 mb-8">Your BeeZee account is secured and ready for business in SA.</p>
