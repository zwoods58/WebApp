...
// import { addOfflineTransaction } from '../utils/offlineSync'; // Unused
...
export default function AddTransaction() {
  ...
  return (
    <div className="add-transaction-container page-transactions pb-24">
      {showVoiceRecorder && (
      ...
      <div className="px-4 mt-6 space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="bg-white p-6 rounded-[32px] border border-gray-50 shadow-sm flex flex-col items-center gap-3 active:scale-95 transition-transform voice-recorder-hidden"
          >
