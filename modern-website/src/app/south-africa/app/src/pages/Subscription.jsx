          ...
          <div className="border-t pt-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">
                  {subscription?.subscription_tier === 'ai' 
                    ? `${getPricing('ai')?.displayPrice || 'AI Plan'}/${activeCountry?.pricing?.billingCycle || 'month'}`
                    : `${getPricing('manual')?.displayPrice || 'Manual Plan'}/${activeCountry?.pricing?.billingCycle || 'month'}`
                  }
                </p>
              </div>
            </div>
              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-primary-600 font-bold">
                    {getPricing('manual')?.weeklyDisplay || getPricing('manual')?.displayPrice || 'Manual Plan'}
                  </p>
                  <p className="text-sm text-gray-500">
                    Billed {activeCountry?.pricing?.billingCycle || 'monthly'}
                  </p>
                </div>
              </div>
