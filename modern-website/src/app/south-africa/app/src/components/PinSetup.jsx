...
export default function PinSetup({ onPinSet, phoneNumber, countryName }) {
  ...
  const handlePinChange = (index, value, isConfirm = false) => {
    ...
    if (isConfirm) {
      ...
      // Check PIN strength when all 4 digits are entered
  ...
  const handlePaste = (e) => {
    ...
    if (digits.length === 4 && /^\d{4}$/.test(pastedData)) {
      if (currentStep === 1) {
        setPin(digits);
    ...
    <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-sm">
          A 4-digit security PIN to protect your {countryName} account
        </p>
      </div>
        ...
        <div className="flex items-start space-x-2">
          ...
          <div className="text-sm text-yellow-800">
            ...
            <ul className="space-y-1 text-xs">
              <li>• Never share your 4-digit PIN with anyone</li>
