 ...
 */
export default function QuickActionButtons({ onVoiceClick, onReceiptClick, onInventoryClick, onBookingClick }) {
  ...
  const handleBookingsClick = () => {
    console.log('Booking button clicked - opening modal');
    onBookingClick();
  };
  ...
  return (
    <div className="quick-action-buttons">
      <button
        ...
        aria-label={t('dashboard.transaction', 'Transaction')}
      >
