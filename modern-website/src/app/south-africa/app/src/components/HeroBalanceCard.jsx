...
export default function HeroBalanceCard({ 
  ...
  const { formatCurrency, activeCountry } = useCountryStore();
  ...
  return (
    <div className="hero-balance-card">
      ...
      <div className="hero-balance-amount-container">
        <span className="hero-balance-currency-symbol">
          {activeCountry?.currency?.symbol || 'R'}
        </span>
        <div className="hero-balance-amount">
          {formatCurrency(animatedBalance).replace(/[^\d.,]/g, '')}
        </div>
      </div>
