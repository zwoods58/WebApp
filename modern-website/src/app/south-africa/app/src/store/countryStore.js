...
export const useCountryStore = create(
  persist(
    (set, get) => ({
      // Current active country - default to South Africa for SA app
      activeCountry: COUNTRIES.ZA,
      ...
      // Current language for the user - default to English for South Africa
      currentLanguage: 'en',
    ...
    {
      name: 'beezee-za-country-store', // South Africa-specific storage key
      ...
      onRehydrateStorage: () => (state) => {
        if (state) {
          // If no userCountry is set, use the default country (South Africa)
