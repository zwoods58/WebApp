...
const ContactSection = () => {
    ...
    return (
        <section id="contact" className="min-h-screen bg-white text-foreground selection:bg-system-blue selection:text-white overflow-hidden relative border-t border-mist-gray">
