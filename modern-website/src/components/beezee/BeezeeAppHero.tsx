            ...
            <div className="flex-1 overflow-y-auto pt-10 pb-20 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                ...
                <div className="bg-white px-6 py-6 rounded-b-[2.5rem] shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-inner overflow-hidden p-2">
                                <img src="/beezee.png" alt="BeeZee" className="w-full h-full object-contain" />
                            </div>
                    ...
                    <div className="space-y-0.5">
                        <p className="text-gray-400 text-[11px] font-medium tracking-wide flex items-center gap-1.5">
                            <span className="text-sm">👋</span> {t('app.greeting', 'GOOD AFTERNOON, FRIEND')}
                        </p>
                ...
                <div className="mx-4 mt-8 bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                    <div className="flex justify-between items-start mb-3">
                        <span className="text-[10px] text-gray-400 uppercase font-black tracking-widest">{t('app.balance', 'Balance')}</span>
                        <button className="text-[10px] text-system-blue font-black tracking-widest px-2 py-0.5 bg-system-blue/5 rounded-full uppercase">{t('app.demo', 'Demo')}</button>
                    </div>
                ...
                <div className="px-6 mt-8 mb-4">
                    <h3 className="text-[11px] font-black text-gray-300 uppercase tracking-widest mb-4">{t('app.executive_tools', 'Executive Tools')}</h3>
                    <div className="grid grid-cols-2 gap-4">
                        {[
                            { icon: Mic, color: 'purple', label: t('app.voice', 'Voice') },
                            { icon: Camera, color: 'orange', label: t('app.scan', 'Scan') },
                            { icon: Calendar, color: 'green', label: t('app.book', 'Book') },
                            { icon: Package, color: 'blue', label: t('app.stock', 'Stock') }
                        ].map((tool, i) => (
                    ...
                    <div className="mx-4 mt-6 mb-8 bg-gray-900 rounded-[2rem] p-5 shadow-2xl relative overflow-hidden group/tip">
                        ...
                        <div className="flex gap-4 relative z-10">
                            ...
                            <div className="flex-1">
                                <div className="text-system-blue font-black text-[10px] mb-1 tracking-widest uppercase">{t('app.coach_analysis', 'Coach Analysis')}</div>
