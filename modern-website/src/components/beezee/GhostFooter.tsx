            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-24">
                    ...
                    <div className="space-y-6">
                        <div className="font-mono text-[10px] font-medium text-ghost-gray uppercase tracking-[0.1em]">[ SECURITY ]</div>
                        <ul className="space-y-4">
                            <li>
                                <div className="flex items-center gap-2 group cursor-help">
                                    <Shield size={14} className="text-obsidian/40 group-hover:text-system-blue transition-colors" />
                                    <span className="text-[13px] text-obsidian/60 group-hover:text-system-blue transition-colors">Your Data is Safe</span>
                                </div>
                            </li>
                            <li>
                                <div className="flex items-center gap-2 group cursor-help">
                                    <Lock size={14} className="text-obsidian/40 group-hover:text-system-blue transition-colors" />
                                    <span className="text-[13px] text-obsidian/60 group-hover:text-system-blue transition-colors">Privacy Protected</span>
                                </div>
                            </li>
                            <li>
                    ...
                    {/* Column 2: Governance */}
                    <div className="space-y-6">
                        <div className="font-mono text-[10px] font-medium text-ghost-gray uppercase tracking-[0.1em]">[ LEGAL ]</div>
                    ...
                    <div className="space-y-6">
                        <div className="font-mono text-[10px] font-medium text-ghost-gray uppercase tracking-[0.1em]">[ COUNTRIES ]</div>
                        <ul className="space-y-4 text-[13px] text-obsidian/60">
                ...
                <div className="border-t border-glass-border pt-8 pb-12 flex flex-col md:flex-row items-center justify-between gap-6">
                    <p className="text-[11px] text-obsidian/40 max-w-md text-center md:text-left leading-relaxed font-mono uppercase tracking-tighter">
                        Beezee is owned by Atarwebb Ltd (Rwanda Company Code: 153223137).
                        AI-powered business insights and tracking.
                    </p>
                    <div className="flex items-center gap-4 opacity-40 hover:opacity-100 transition-all duration-500">
                        ...
                        <div className="rotate-[1deg] px-2 py-1 text-[11px] font-black font-mono text-obsidian/60 tracking-[0.1em] border-2 border-obsidian/20 rounded-sm">AFRICA</div>
                    </div>
                </div>
                ...
                <div className="border-t border-glass-border pt-8 flex justify-center">
                    <div className="group relative">
                        <div className="font-mono text-[10px] text-ghost-gray tracking-[0.2em] hover:text-system-blue transition-colors cursor-help uppercase italic">
                            © 2026 BEEZEE // HELPING BUSINESSES GROW // {latency}MS SPEED
                        </div>
                    </div>
                </div>
