...
"[project]/Downloads/WebApp/WebApp-main/modern-website/src/app/api/auth/check-phone/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data: business, error } = await supabaseAdmin.from('businesses').select('id, business_name, phone_number').eq('phone_number', phoneNumber).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c83571d._.js.map